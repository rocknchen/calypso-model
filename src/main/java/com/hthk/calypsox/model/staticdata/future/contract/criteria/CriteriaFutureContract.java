...
import static com.hthk.fintech.model.data.datacenter.query.EntityTypeEnum.FUTURE_CONTRACT;
 ...
 * @Date: 2024/1/9 18:47
 */
@Criteria(actions = {GET, COUNT}, type = FUTURE_CONTRACT, appName = ApplicationEnum.CALYPSO)
